...
test-vagrant:
	...
	testinfra --hosts=mongodb_mms_server_trusty --ssh-config=.vagrant/ssh-config --noconftest --sudo
	testinfra --hosts=mongodb_mms_server_xenial --ssh-config=.vagrant/ssh-config --noconftest --sudo
